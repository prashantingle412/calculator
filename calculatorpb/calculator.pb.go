...
type PrimeNumberDecompositionResponse struct {
	...
	Devisior int64 `protobuf:"varint,1,opt,name=Devisior,proto3" json:"Devisior,omitempty"`
}
...
func (x *PrimeNumberDecompositionResponse) GetDevisior() int64 {
	if x != nil {
		return x.Devisior
	}
	return 0
...
func (x *SqaurRootRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SqaurRootRequest) ProtoMessage() {}

func (x *SqaurRootRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SqaurRootRequest.ProtoReflect.Descriptor instead.
func (*SqaurRootRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{8}
}

func (x *SqaurRootRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
type SqaurRootResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SquarRoot float64 `protobuf:"fixed64,1,opt,name=squar_root,json=squarRoot,proto3" json:"squar_root,omitempty"`
}

func (x *SqaurRootResponse) Reset() {
	*x = SqaurRootResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SqaurRootResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SqaurRootResponse) ProtoMessage() {}

func (x *SqaurRootResponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SqaurRootResponse.ProtoReflect.Descriptor instead.
func (*SqaurRootResponse) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{9}
}

func (x *SqaurRootResponse) GetSquarRoot() float64 {
	if x != nil {
		return x.SquarRoot
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x22, 0x26, 0x0a, 0x12, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x75, 0x6d,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x73, 0x75, 0x6d, 0x22, 0x39, 0x0a, 0x1f, 0x50,
	...
	0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x3e, 0x0a, 0x20, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x44, 0x65,
	0x76, 0x69, 0x73, 0x69, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x44, 0x65,
	0x76, 0x69, 0x73, 0x69, 0x6f, 0x72, 0x22, 0x2f, 0x0a, 0x15, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74,
	...
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x02, 0x52, 0x07, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x22, 0x2c, 0x0a, 0x12, 0x46,
	...
	0x05, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x27, 0x0a, 0x13, 0x46, 0x69, 0x6e,
	...
	0x61, 0x78, 0x22, 0x2a, 0x0a, 0x10, 0x53, 0x71, 0x61, 0x75, 0x72, 0x52, 0x6f, 0x6f, 0x74, 0x52,
	...
	0x0a, 0x11, 0x53, 0x71, 0x61, 0x75, 0x72, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x71, 0x75, 0x61, 0x72, 0x5f, 0x72, 0x6f, 0x6f,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x09, 0x73, 0x71, 0x75, 0x61, 0x72, 0x52, 0x6f,
	0x6f, 0x74, 0x32, 0xdc, 0x03, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
	0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4d, 0x0a, 0x0a, 0x43, 0x61, 0x6c, 0x63,
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x1d, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x4a, 0x0a, 0x09, 0x53, 0x71, 0x61, 0x75, 0x72, 0x52, 0x6f,
	0x6f, 0x74, 0x12, 0x1c, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e,
	0x53, 0x71, 0x61, 0x75, 0x72, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1d, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x53, 0x71,
	0x61, 0x75, 0x72, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*SqaurRootRequest)(nil),                 // 8: calculator.SqaurRootRequest
	(*SqaurRootResponse)(nil),                // 9: calculator.SqaurRootResponse
}
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	8, // 4: calculator.CalculatorService.SqaurRoot:input_type -> calculator.SqaurRootRequest
	1, // 5: calculator.CalculatorService.Calculator:output_type -> calculator.CalculatorResponse
	...
	9, // 9: calculator.CalculatorService.SqaurRoot:output_type -> calculator.SqaurRootResponse
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SqaurRootResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
